...
| Strategy `index-pullback-v1` | Version `1.2.0`, paper-forward-observation lifecycle | Versioned SI.1 suitability may become `ENABLED` only for paper observation when all market/risk evidence passes; live trading remains unapproved |
