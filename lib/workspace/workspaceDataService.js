...
import { marketRegimeOrchestrator } from '../market/regime/marketRegimeOrchestrator.js'
...
export function createWorkspaceDataService({
  ...
  regimeOrchestrator = marketRegimeOrchestrator,
  indicatorPipeline,
} = {}) {
  ...
  return {
    ...
    async getMarketOverview(symbol, { timeframe = '1D', now } = {}) {
