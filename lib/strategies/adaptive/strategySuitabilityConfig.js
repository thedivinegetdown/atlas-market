export const DEFAULT_STRATEGY_SUITABILITY_CONFIG = Object.freeze({
  ...
  strategies: Object.freeze({
    ...
    'range-mean-reversion-v1': Object.freeze({
      trend: Object.freeze({ enabled: Object.freeze(['RANGE']), conditional: Object.freeze(['BULL', 'STRONG_BULL']) }),
      volatility: Object.freeze({ enabled: Object.freeze(['NORMAL_VOLATILITY', 'LOW_VOLATILITY']), conditional: Object.freeze(['HIGH_VOLATILITY']) }),
      risk: Object.freeze({ enabled: Object.freeze(['RISK_ON']), conditional: Object.freeze(['NEUTRAL']) }),
      requiredIndicators: Object.freeze([]),
    }),
    'volatility-expansion-v1': Object.freeze({ trend: Object.freeze({ enabled: Object.freeze(['STRONG_BULL', 'BULL']), conditional: Object.freeze(['RANGE']) }), volatility: Object.freeze({ enabled: Object.freeze(['LOW_VOLATILITY', 'NORMAL_VOLATILITY']), conditional: Object.freeze(['HIGH_VOLATILITY']) }), risk: Object.freeze({ enabled: Object.freeze(['RISK_ON']), conditional: Object.freeze(['NEUTRAL']) }), requiredIndicators: Object.freeze([]) }),
  }),
})
...
export const EXISTING_ADAPTIVE_STRATEGY_RECORDS = Object.freeze([
  ...
  Object.freeze({
    strategyId: 'range-mean-reversion-v1', strategyName: 'Range Mean Reversion', versionReference: '1.0.0',
    status: 'paper_forward_observation', lifecycleState: 'paper_forward_observation', validationStatus: 'valid',
    activationEligibilityStatus: 'paper_observation', timeframeReferences: Object.freeze(['swing']),
    compatibleAssetClasses: Object.freeze(['etf', 'equity']), paperTrading: true,
    paperForwardObservationApproved: true, liveTradingApproved: false,
  }),
  Object.freeze({ strategyId: 'volatility-expansion-v1', strategyName: 'Volatility Expansion', versionReference: '1.0.0', status: 'paper_forward_observation', lifecycleState: 'paper_forward_observation', validationStatus: 'valid', activationEligibilityStatus: 'paper_observation', timeframeReferences: Object.freeze(['swing']), compatibleAssetClasses: Object.freeze(['etf', 'equity']), paperTrading: true, paperForwardObservationApproved: true, liveTradingApproved: false }),
])
