...
const PLACEHOLDER_FAMILIES = Object.freeze([
  Object.freeze({ strategyId: 'range-mean-reversion-v1', familyId: 'range-mean-reversion', displayName: 'Range Mean Reversion' }),
...
function implementedRecord(record = {}) {
  ...
  return {
    strategyId,
    familyId: strategyId === 'index-pullback-v1' ? 'trend-pullback' : strategyId === 'breakout-momentum-v1' ? 'breakout-momentum' : 'unclassified',
    displayName: record.strategyName ?? strategyId,
    version: record.versionReference ?? (strategyId === 'index-pullback-v1' ? INDEX_PULLBACK_STRATEGY_VERSION : strategyId === 'breakout-momentum-v1' ? BREAKOUT_MOMENTUM_STRATEGY_VERSION : null),
    ...
    exitPolicyId: strategyId === 'index-pullback-v1' ? INDEX_PULLBACK_EXIT_POLICY_VERSION : strategyId === 'breakout-momentum-v1' ? BREAKOUT_MOMENTUM_EXIT_POLICY_VERSION : null,
