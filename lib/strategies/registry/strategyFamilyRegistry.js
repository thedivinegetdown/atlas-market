...
const PLACEHOLDER_FAMILIES = Object.freeze([
  Object.freeze({ strategyId: 'breakout-momentum-v1', familyId: 'breakout-momentum', displayName: 'Breakout Momentum' }),
...
function implementedRecord(record = {}) {
  ...
  return {
    strategyId,
    familyId: strategyId === 'index-pullback-v1' ? 'trend-pullback' : 'unclassified',
    displayName: record.strategyName ?? strategyId,
    version: record.versionReference ?? (strategyId === 'index-pullback-v1' ? INDEX_PULLBACK_STRATEGY_VERSION : null),
    ...
    exitPolicyId: strategyId === 'index-pullback-v1' ? INDEX_PULLBACK_EXIT_POLICY_VERSION : null,
