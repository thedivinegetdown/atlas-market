...
export async function buildDecisionIntelligence({ tenantContext = {}, accountId, selectedPlanId = null, evidenceRepository, ledgerRepository, evaluations, positions, account, executions, correlationEvidence = null, marketContext = null, generatedAt = new Date().toISOString() } = {}) {
  ...
  const copilotContext = buildAtlasDecisionContext({ plans, ranking, portfolioAdmissions: admissions, strategyRegistry: registry, decisionQuality, marketContext, selectedPlanId, generatedAt })
