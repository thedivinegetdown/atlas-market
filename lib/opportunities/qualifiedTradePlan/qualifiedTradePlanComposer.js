...
function decisionStatus({ evaluation = {}, tradeQuality = {}, strategySuitability = {}, regime = {}, riskGate = {}, quantity }) {
  ...
  const strategy = strategySuitability.decision ?? evaluation.strategySuitability?.decision
  ...
  if (evaluation.status === 'APPROVED_FOR_PAPER_REVIEW' && strategy === 'ENABLED' && marketStatus === 'COMPLETE') return 'QUALIFIED'
  return 'NO_TRADE'
}
