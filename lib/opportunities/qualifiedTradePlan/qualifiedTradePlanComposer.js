...
export function composeQualifiedTradePlan({ candidate = {}, tradeQuality = {}, regime = {}, strategySuitability = {}, evaluation = {}, riskGate = {}, sizing = {}, strategyVersion = null, policyFingerprint = null, strategyFingerprint = null } = {}, options = {}) {
  ...
  return Object.freeze({
    ...
    strategyId,
    strategyVersion,
    strategyFamily: strategyId === 'breakout-momentum-v1' ? 'breakout-momentum' : strategyId === 'range-mean-reversion-v1' ? 'range-mean-reversion' : strategyId === 'index-pullback-v1' ? 'trend-pullback' : null,
    generatedAt,
