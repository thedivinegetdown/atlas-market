...
export function createForwardObservationManifest(input = {}) {
  ...
  if (manifest.exitPolicy.version !== INDEX_PULLBACK_EXIT_POLICY_VERSION || manifest.exitPolicy.policyFingerprint !== INDEX_PULLBACK_EXIT_POLICY_DEFINITION_FINGERPRINT || manifest.exitPolicy.maximumHoldingSessions !== 20) throw new Error('approved index-pullback exit policy is required')
