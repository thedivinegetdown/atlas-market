...
export function simulatePaperPositionExit({ position, account = {}, quantity, quote = {}, existingExits = [], paperModeEnabled = true, exitReason, policyBar, sessionsHeld } = {}, options = {}) {
  ...
  const policyEvaluators = { 'index-pullback-exit-v1.0.0': evaluateIndexPullbackExitPolicy, 'breakout-momentum-exit-v1.0.0': evaluateBreakoutMomentumExitPolicy, 'range-mean-reversion-exit-v1.0.0': evaluateRangeMeanReversionExitPolicy }
