...
function fingerprint(candidate, regime, suitability) {
  return createHash('sha256').update(JSON.stringify([candidate.opportunityId, candidate.strategyId, candidate.evidenceFingerprint ?? null, regime.engineVersion, regime.asOf, candidate.engineVersion, candidate.asOf, suitability?.decision])).digest('hex')
}
