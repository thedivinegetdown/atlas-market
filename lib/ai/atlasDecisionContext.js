...
export function buildAtlasDecisionContext({ plans = [], ranking = {}, portfolioAdmissions = [], strategyRegistry = {}, decisionQuality = null, selectedPlanId = null, generatedAt = new Date().toISOString() } = {}) {
  ...
  return Object.freeze({
    ...
    market: selectedProjection ? { regime: selectedProjection.regime } : { regime: 'UNAVAILABLE' },
