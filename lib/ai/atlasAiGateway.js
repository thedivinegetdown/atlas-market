...
export function createAtlasAiGateway({ providers = {}, aiConfig = {}, eventBus = defaultEventBus, clock = () => Date.now(), env = process.env, fetchImpl = globalThis.fetch, providerHealth = {} } = {}) {
