    ...
    async saveTradeQualityReview(input = {}) {
      ...
      await database.query(
        `INSERT INTO atlas_ai_opportunity_analysis_history
         ...
         RETURNING id`,
        [id, tenantContext.organizationId, tenantContext.teamWorkspaceId ?? null, accountId, userId, `trade-quality-${userId}`, snapshot.symbol, snapshot.reviewState, reviewedAt, snapshot.asOf, [snapshot.opportunityId], snapshot.evidenceFingerprint, payload, expiresAt],
      )
