...
function assertAccess(membership, method) {
  ...
  throw new AppError(ERROR_CODES.VALIDATION_ERROR, 'Release gate access denied', { statusCode: 403, publicMessage: 'release gate access denied' })
}

export function createReleaseGateHandler(options = {}) {
...
export const handler = createReleaseGateHandler()
